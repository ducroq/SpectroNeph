...
void handlePing(const JsonObject &params, JsonObject &response, JsonObject &command)
{
...
void handleGetInfo(const JsonObject &params, JsonObject &response, JsonObject &command)
{
...
void handleAs7341Init(const JsonObject &params, JsonObject &response, JsonObject &command)
{
...
void handleAs7341Config(const JsonObject &params, JsonObject &response, JsonObject &command)
{
...
void handleAs7341Read(const JsonObject &params, JsonObject &response, JsonObject &command)
{
...
void handleAs7341Led(const JsonObject &params, JsonObject &response, JsonObject &command)
{
...
void handleStreamStart(const JsonObject &params, JsonObject &response, JsonObject &command)
{
    // Start a data stream
...
void handleStreamStop(const JsonObject &params, JsonObject &response, JsonObject &command)
{
    // Stop a data stream
    if (!params.containsKey("type"))
    {
...
void handleGetStreams(const JsonObject &params, JsonObject &response, JsonObject &command)
{
...
void handleResetDevice(const JsonObject &params, JsonObject &response, JsonObject &command)
{
    // Stop all streams
